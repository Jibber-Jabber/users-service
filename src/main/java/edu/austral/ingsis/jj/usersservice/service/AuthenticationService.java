...
public class AuthenticationService {
    ...
    public LoginResponseDto authenticate(LoginDto loginDto, HttpServletResponse response) {
        ...
        response.setHeader("Set-Cookie", "jwt=" + jwt + "; HttpOnly; Secure=true; SameSite=strict; Path=/");
    ...
    public void logout(HttpServletResponse response){
        response.setHeader("Set-Cookie", "jwt=" + "" + "; HttpOnly; Secure=true; SameSite=strict; Path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT");
    }
